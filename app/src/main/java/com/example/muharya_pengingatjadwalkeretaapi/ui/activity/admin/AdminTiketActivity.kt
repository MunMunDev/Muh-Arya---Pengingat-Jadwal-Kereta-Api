...
import com.example.muharya_pengingatjadwalkeretaapi.adapter.AdminListTanggalTiketAdapter
...
class AdminTiketActivity : Activity() {
...
//    private lateinit var adapter: AdminTiketAdapter
    private lateinit var adapter: AdminListTanggalTiketAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        kontrolNavigationDrawer = KontrolNavigationDrawer(this@AdminTiketActivity)
        sharedPref = SharedPreferencesLogin(this@AdminTiketActivity)
        loading = LoadingAlertDialog(this@AdminTiketActivity)
...
//        getDataKotaKab()
        ...
        binding.apply {
            ...
            kontrolNavigationDrawer.onClickItemNavigationDrawer(navView, drawerLayoutMain, ivDrawerView, this@AdminTiketActivity)
...
//            }
    ...
    private fun getData(){
        ApiService.getRetrofit().getTiketAdmin("")
            .enqueue(object: Callback<ArrayList<TiketModel>>{
                override fun onResponse(
                    ...
                    if(response.body()!!.isNotEmpty()){
                        ...
                        adapter = AdminListTanggalTiketAdapter(arrayTanggalTiket, object: AdminListTanggalTiketAdapter.clickListener{
                            override fun onClickItemListener(tanggal: String, it: View) {
                                val intent = Intent(this@AdminTiketActivity, AdminDetailsTiketActivity::class.java)
                                intent.putExtra("tanggal", tanggal)
                                startActivity(intent)
                            }
                        })

                        binding.rvTiket.layoutManager = GridLayoutManager(this@AdminTiketActivity, 2)
                        binding.rvTiket.adapter = adapter
                    }
                    else{
                        Toast.makeText(this@AdminTiketActivity, "Belum Ada Tiket", Toast.LENGTH_SHORT).show()
                    }
                    loading.alertDialogCancel()
                }

                override fun onFailure(call: Call<ArrayList<TiketModel>>, t: Throwable) {
                    Toast.makeText(this@AdminTiketActivity, "Periksa Jaringan Anda", Toast.LENGTH_SHORT).show()
                    loading.alertDialogCancel()
                }
...
//                                val popupMenu = PopupMenu(this@AdminTiketActivity, it)
...
//                        }
//
//                        binding.rvTiket.layoutManager = LinearLayoutManager(this@AdminTiketActivity)
//                        binding.rvTiket.adapter = adapter
//                    }
//                    else{
//                        Toast.makeText(this@AdminTiketActivity, "Belum Ada Tiket", Toast.LENGTH_SHORT).show()
...
//    // Tambah
    fun dialogTambahDataPerminggu(){
        val viewAlertDialog = View.inflate(this@AdminTiketActivity, R.layout.alert_dialog_admin_tiket_perminggu, null)
        ...
        val alertDialog = AlertDialog.Builder(this@AdminTiketActivity)
...
////                }
////                else{
////                    Toast.makeText(this@AdminTiketActivity, "Hanya Bisa Digunakan Pada Hari Minggu", Toast.LENGTH_SHORT).show()
////                }
//            }
        }
        ...
        ApiService.getRetrofit().postAdminTambahTiketPermingguStasiun("")
            .enqueue(object: Callback<TiketModel>{
                override fun onResponse(call: Call<TiketModel>, response: Response<TiketModel>) {
                    Toast.makeText(this@AdminTiketActivity, "Berhasil Tambah", Toast.LENGTH_SHORT).show()
                    getData()
                }
...
//    fun dialogTambah(){
//        val viewAlertDialog = View.inflate(this@AdminTiketActivity, R.layout.alert_dialog_admin_tiket,  null)
//
...
//                }
//
//                val arrayAdapterStasiun = ArrayAdapter(this@AdminTiketActivity, android.R.layout.simple_spinner_item, arrayStasiunValue)
...
////            val hour = 12
////            val minute = 0
////            val mTimePicker: TimePickerDialog = TimePickerDialog(this@AdminTiketActivity,
...
//                }
//                else{
//                    Toast.makeText(this@AdminTiketActivity, "Tanggal Harus ada pada seminggu ini", Toast.LENGTH_SHORT).show()
//                }
//            }
...
//
//                override fun onFailure(call: Call<TiketModel>, t: Throwable) {
//                    Toast.makeText(this@AdminTiketActivity, "Gagal Tambah", Toast.LENGTH_SHORT).show()
//                    getData()
////                    loading.alertDialogCancel()
//                }
//
...
//            .enqueue(object: Callback<TiketModel>{
//                override fun onResponse(call: Call<TiketModel>, response: Response<TiketModel>) {
//                    Toast.makeText(this@AdminTiketActivity, "Berhasil Update Data", Toast.LENGTH_SHORT).show()
//                    getData()
//                }
//
//                override fun onFailure(call: Call<TiketModel>, t: Throwable) {
...
//        val viewAlertDialog = View.inflate(this@AdminTiketActivity, R.layout.alert_dialog_admin_hapus_tiket,  null)
//
//        val tvTanggal = viewAlertDialog.findViewById<TextView>(R.id.tvTanggal)
//        val tvWaktu = viewAlertDialog.findViewById<TextView>(R.id.tvWaktu)
...
//            .enqueue(object: Callback<TiketModel>{
//                override fun onResponse(call: Call<TiketModel>, response: Response<TiketModel>) {
//                    Toast.makeText(this@AdminTiketActivity, "Berhasil Hapus Data", Toast.LENGTH_SHORT).show()
//                    getData()
//                }
//
//                override fun onFailure(call: Call<TiketModel>, t: Throwable) {
//                    Toast.makeText(this@AdminTiketActivity, "Gagal Hapus", Toast.LENGTH_SHORT).show()
//                    getData()
//                }
//
//            })
...
//        val minute = 0
    ...
    fun selectedDate(tv: TextView, tanggal:String){
        ...
        val mDatePicker = DatePickerDialog(this@AdminTiketActivity, DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
    ...
    override fun onBackPressed() {
        startActivity(Intent(this@AdminTiketActivity, AdminHomeActivity::class.java))
        finish()
        super.onBackPressed()
    }
}